...
namespace CommunityPortal.Migrations
{
    ...
    [Migration("20250214025938_service request")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommunityPortal.Models.Billing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommunityPortal.Models.Billing", b =>
                {
                    b.HasOne("CommunityPortal.Models.ServiceRequest", "ServiceRequest")
                        .WithOne("Billing")
                        .HasForeignKey("CommunityPortal.Models.Billing", "ServiceRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
